...
import { Menu, X, ChevronDown, Eye, EyeOff, User, Lock, Mail, Phone } from 'lucide-react';
            ...
            {isLoggedIn ? (
              <div ref={profileDropdownRef} className="relative">
                ...
                >
                  ...
                  <span className="text-[13px] font-bold text-slate-800">John Doe</span>
              ...
              <div className="flex flex-col gap-2">
                <div className="flex items-center gap-3 bg-slate-50 border border-slate-150 p-3.5 rounded-xl">
                  ...
                  <div className="flex flex-col text-left">
                    <span className="text-[14px] font-bold text-slate-800 leading-none">John Doe</span>
                    <span className="text-[11px] font-semibold text-slate-400 mt-1 leading-none">name@example.com</span>
                  </div>
                </div>
                <button
                  onClick={() => {
