              ...
              {['Overview', 'Rooms', 'Amenities', 'Reviews', 'Location', 'Policies'].map((tab) => {
                ...
                return (
                  <button
                    ...
                    className={`py-4 text-[13.5px] font-extrabold border-b-3 whitespace-nowrap cursor-pointer transition-all leading-none ${isActive
            ...
            <div className="md:col-span-3 space-y-6">
              ...
              <div className="bg-white rounded-3xl border border-slate-200 p-5 shadow-sm sticky top-36 text-left">
                ...
                <button
                  ...
                  className={`w-full py-3.5 rounded-xl font-bold text-[13px] shadow-xs mt-5 cursor-pointer text-center block transition-all active:scale-97 ${hasSelectedRooms
          ...
          <div className="flex justify-center gap-3 p-4 overflow-x-auto no-scrollbar">
            {stay.images.map((imgUrl, idx) => (
              <img
                ...
                className={`w-16 h-12 object-cover rounded-md cursor-pointer border-2 transition-all ${galleryIndex === idx ? 'border-teal-500 scale-105' : 'border-transparent opacity-60 hover:opacity-100'
                  }`}
              />
            ))}
          </div>
            ...
            {chatMessages.map((msg, idx) => {
              ...
              return (
                <div key={idx} className={`flex ${isUser ? 'justify-end' : 'justify-start'}`}>
                  <div className={`max-w-[80%] rounded-2xl px-3 py-2 ${isUser
